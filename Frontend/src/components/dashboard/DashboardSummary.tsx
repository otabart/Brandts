        ...
        <section className="py-5 md:py-10 lg:py-20 px-5 sm:px-10 md:px-15 xl:px-20">
            ...
            <main className="text-xs md:text-sm xl:text-base mt-10">
                <div className="flex flex-wrap gap-4 mt-10">
                    ...
                    <DashboardCard icon={<MoneySend size="32" variant="Bold" className="text-[#fc5959]" />} amount={`${details.totalBudgetSpent} eth`} color="text-[#fc5959]" text="Total Budget Spent" otherClass="border-[#fc5959]" />
